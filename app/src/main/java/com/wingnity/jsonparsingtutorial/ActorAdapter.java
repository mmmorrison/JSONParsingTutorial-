...
public class ActorAdapter extends ArrayAdapter<Decisions> {
	ArrayList<Decisions> actorList;
	LayoutInflater vi;
	int Resource;
	ViewHolder holder;

	public ActorAdapter(Context context, int resource, ArrayList<Decisions> objects) {
